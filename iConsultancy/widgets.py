...
#final search menu
full_display = widgets.VBox([search_box, status_menu, stage_text, owner_text, tag_box, nextdate_range_menu, tasktype_text, val_box, button_with_check,file_name_text,out])